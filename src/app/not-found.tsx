...
export default function NotFound () {
    return (
        <div style={{ display: 'flex', width: '100vw', height: '100vh' }}>
            ...
            <div style={{ minWidth: '400px', height: '100%', background: manifest().theme_color, position: 'absolute', left: '0px', top: '0px', color: 'white' }}>
                <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'end', height: '100%' }}>
                    <h1 style={{ fontFamily: 'system-ui', fontSize: '60px', right: '-240px', position: 'relative' }}>404 - Not Found</h1>
                    <p style={{ right: '-240px', position: 'relative' }}>Não conseguimos encontrar os recursos que você esta procurando</p>
                    <Link href="/bypass">
