...
export default function CardTitleCustom ({ text }: { text: string }) {
    return (
        <div style={{ width: '100%', overflow: 'hidden', height: '125px', transition: 'none', borderRadius: '15px', background: `linear-gradient(90deg, rgba(10,146,240,${opacity}) 0%, rgba(10,4,168,${opacity}) 39%, rgba(10,4,168,${opacity}) 65%, rgba(10,146,240,${opacity}) 100%)` }}>
